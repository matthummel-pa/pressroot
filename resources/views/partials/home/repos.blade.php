...
<section class="prt-wrap" style="padding-top:80px; padding-bottom:30px;">
  <div style="display:flex; align-items:flex-end; justify-content:space-between; flex-wrap:wrap; gap:12px; margin-bottom:32px;">
    <div>
      <h2 style="font-family:var(--font-display); font-weight:800; font-size:clamp(34px,4vw,46px); letter-spacing:-.025em; margin:0 0 8px; color:var(--color-h2, var(--color-ink));">Building in the <span style="color:#7C5CFF;">open</span></h2>
