...
add_action('init', function () {
    ...
    foreach ([
        'prt-heroes'      => __('MH Â· Heroes', 'pressroot'),
        'prt-cta'         => __('MH Â· Call to action', 'pressroot'),
        'prt-content'     => __('MH Â· Content', 'pressroot'),
        'prt-socialproof' => __('MH Â· Social proof', 'pressroot'),
        'prt-dev'         => __('MH Â· Developer', 'pressroot'),
    ] as $slug => $label) {
    ...
    $patterns['matthummel/hero-centered-minimal'] = ['title' => __('Hero â€” centered minimal', 'pressroot'), 'categories' => ['prt-heroes', 'pressroot'], 'content' => <<<'HTML'
...
HTML];
    ...
    $patterns['matthummel/hero-dev'] = ['title' => __('Hero â€” developer (with repos)', 'pressroot'), 'categories' => ['prt-heroes', 'prt-dev', 'pressroot'], 'content' => <<<'HTML'
<!-- wp:group {"className":"prt-hero","layout":{"type":"constrained"}} -->
<div class="wp-block-group prt-hero"><!-- wp:paragraph {"align":"center","className":"prt-eyebrow"} -->
<p class="has-text-align-center prt-eyebrow">OPEN SOURCE Â· BUILDING IN PUBLIC</p>
<!-- /wp:paragraph -->
...
HTML];
    ...
    $patterns['matthummel/cta-split'] = ['title' => __('CTA â€” split', 'pressroot'), 'categories' => ['prt-cta', 'pressroot'], 'content' => <<<'HTML'
...
HTML];
    ...
    $patterns['matthummel/about-two-col'] = ['title' => __('About â€” two column', 'pressroot'), 'categories' => ['prt-content', 'pressroot'], 'content' => <<<'HTML'
...
HTML];
    ...
    $patterns['matthummel/services-three'] = ['title' => __('Services â€” three cards', 'pressroot'), 'categories' => ['prt-content', 'pressroot'], 'content' => <<<'HTML'
...
HTML];
    ...
    $patterns['matthummel/stats-four'] = ['title' => __('Stats â€” four up', 'pressroot'), 'categories' => ['prt-socialproof', 'pressroot'], 'content' => <<<'HTML'
...
HTML];
    ...
    $patterns['matthummel/testimonial-single'] = ['title' => __('Testimonial â€” single large', 'pressroot'), 'categories' => ['prt-socialproof', 'pressroot'], 'content' => <<<'HTML'
...
<blockquote class="wp-block-quote is-style-prt-card"><!-- wp:paragraph {"align":"center"} --><p class="has-text-align-center">"A genuinely standout testimonial that's specific about the result and easy to believe."</p><!-- /wp:paragraph --><cite>Client name â€” Company</cite></blockquote>
<!-- /wp:quote --></div>
<!-- /wp:group -->
HTML];

    $patterns['matthummel/contact-cta'] = ['title' => __('Contact CTA â€” with socials', 'pressroot'), 'categories' => ['prt-cta', 'pressroot'], 'content' => <<<'HTML'
